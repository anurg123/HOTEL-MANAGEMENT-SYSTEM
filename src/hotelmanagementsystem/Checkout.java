...
public class Checkout extends JFrame implements ActionListener{
    ...
    Checkout(){ 
        ...
        lblcheckin.setBounds(30,180,160,30);
        add(lblcheckin);
        ...
        fetch.setBounds(100,320,120,30);
    ...
    public void actionPerformed(ActionEvent ae)
    {
         ...
         if (ae.getSource()==fetch)
        {
            ...
            try{
               Conn c=new Conn();
               ResultSet rs1=c.s.executeQuery("select * from customer where number='"+ccustomer.getSelectedItem()+"'");
               rs1.next();
